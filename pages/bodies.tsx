...
const Bodies = () => {
  return (
    <>
      <Head>
        <title>Truck bodies | Quality Auto Services</title>
      </Head>
      <div className={styles.container}>
        ...
        <div className={styles.trucksContainer}>
          <TruckCard
            ...
            image={"/flat-bed-recovery-truck.jpg"}
            imageAlt={"/flat-bed-recovery-truck.jpg"}
          />
          <TruckCard
            name={"Tilt & slide"}
            slug={"tilt-and-slide"}
            ...
            image={"/tilt_and_slide-recovery-truck.jpg"}
          ...
          <TruckCard
            ...
            image={"/twin-deck-recovery-truck.jpg"}
            imageAlt={"/flat-bed-recovery-truck.jpg"}
          />
        </div>
      </div>
