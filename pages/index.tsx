...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>Quality Auto Services</title>
      </Head>
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p>
            Recovery trucks are essential vehicles that help transport
            broken-down or damaged vehicles from one place to another. Whether
            you're in the towing business, operate a breakdown service, or need
            a recovery truck for your personal use, we offer a wide selection of
            quality recovery trucks to suit your needs.
          </p>
        </section>
        <section className={styles.section}>
          ...
          <div className={styles.customHr}></div>
          <p>
            There are several types of recovery trucks available, each with
            their own unique features and benefits. Our website provides
            detailed information on the different types of recovery trucks,
            including tilt and slide, beaver tail, flatbed, and heavy recovery
            trucks. We'll help you determine which type of truck is best suited
            for your needs.
          </p>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.customHr}></div>
          <p>
            When purchasing a recovery truck, there are several important
          ...
          <div className={styles.information}>
            ...
            <p>
              Our website provides detailed information on these features to
