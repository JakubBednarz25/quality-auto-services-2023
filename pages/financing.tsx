      ...
      <div className={styles.wrapper}>
        <section className={styles.introduction}>
          <div className={styles.text}>
            <p>
              Welcome to the Financing page for recovery truck bodies at Quality
              Auto Services. Here, we aim to make it easy and accessible for our
              customers to finance their recovery truck body purchases with the
              help of our trusted partner, Access Business Finance.
            </p>
            <p>
        ...
        <section className={styles.access}>
          ...
          <p>
            ...
            approved within as little as 15 minutes and offer a 121 approach the
